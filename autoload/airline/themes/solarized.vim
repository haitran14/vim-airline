...
function! airline#themes#solarized#refresh()
  ...
  if s:background == 'dark'
    let s:N1 = [s:base02, s:base3, 'bold']
    let s:N2 = [s:base2, (s:tty ? s:base01 : s:base00), '']
    let s:N3 = [s:base1, s:base02, '']
  else
    let s:N1 = [s:base2, s:base02, 'bold']
    let s:N2 = [(s:tty ? s:base01 : s:base3), s:base00, '']
  ...
  if s:background == 'dark'
    let s:IA = [s:base03, s:base00, '']
  else
    let s:IA = [s:base3, s:base0, '']
  endif
